...
public class WelcomeViewHolder extends RecyclerView.ViewHolder {
    ...
    public WelcomeViewHolder(View itemView, MessageInsertListner messageInsertListner) {
        super(itemView);
    ...
    void addSugession(ArrayList<String> sugessionArrayList) {
        ...
        SugessionAdapter sugessionAdapter = new SugessionAdapter(arrayList,messageInsertListner);
