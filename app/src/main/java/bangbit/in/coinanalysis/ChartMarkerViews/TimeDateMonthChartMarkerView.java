...
public class TimeDateMonthChartMarkerView extends MarkerView {

    private TextView priceTextView;
    private TextView timeTextView;

    public TimeDateMonthChartMarkerView(Context context, int layoutResource) {
    ...
    public void refreshContent(Entry e, Highlight highlight) {
        ...
        int val= (int) e.getX();
        String time="Time : "+ Util.getTimeDayFromUnixTime(val);
