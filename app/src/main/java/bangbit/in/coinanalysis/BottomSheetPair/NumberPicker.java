...
public class NumberPicker extends LinearLayout {
    ...
    private Typeface notselectedTypeface;
    ...
    /**
     * The {@link com.shawnlin.numberpicker.Scroller} responsible for flinging the selector.
     */
    private final com.shawnlin.numberpicker.Scroller mFlingScroller;

    /**
     * The {@link com.shawnlin.numberpicker.Scroller} responsible for adjusting the selector.
     */
    private final com.shawnlin.numberpicker.Scroller mAdjustScroller;
    ...
    public NumberPicker(Context context) {
        this(context, null);
        selectedTypeface = Typeface.createFromAsset(context.getAssets(),"fonts/rokkitt_bold.ttf");
        notselectedTypeface = Typeface.createFromAsset(context.getAssets(),"fonts/rokkitt_regular.ttf");
    }
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        selectedTypeface = Typeface.createFromAsset(mContext.getAssets(),"fonts/rokkitt_bold.ttf");
        notselectedTypeface = Typeface.createFromAsset(mContext.getAssets(),"fonts/rokkitt_regular.ttf");
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, com.shawnlin.numberpicker.R.styleable.NumberPicker, defStyle, 0);

        mSelectionDivider = ContextCompat.getDrawable(context, com.shawnlin.numberpicker.R.drawable.np_numberpicker_selection_divider);

        mSelectionDividerColor = attributesArray.getColor(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_dividerColor, mSelectionDividerColor);
        ...
        mSelectionDividersDistance = attributesArray.getDimensionPixelSize(
            com.shawnlin.numberpicker.R.styleable.NumberPicker_np_dividerDistance, defSelectionDividerDistance);
        ...
        mSelectionDividerThickness = attributesArray.getDimensionPixelSize(
                com.shawnlin.numberpicker.R.styleable.NumberPicker_np_dividerThickness, defSelectionDividerThickness);

        mOrder = attributesArray.getInt(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_order, ASCENDING);
        mOrientation = attributesArray.getInt(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_orientation, VERTICAL);

        mWidth = attributesArray.getDimensionPixelSize(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_width, SIZE_UNSPECIFIED);
        mHeight = attributesArray.getDimensionPixelSize(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_height, SIZE_UNSPECIFIED);

        setWidthAndHeight();

        mComputeMaxWidth = true;

        mValue = attributesArray.getInt(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_value, mValue);
        mMaxValue = attributesArray.getInt(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_max, mMaxValue);
        mMinValue = attributesArray.getInt(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_min, mMinValue);

        mSelectedTextColor = attributesArray.getColor(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_selectedTextColor, mSelectedTextColor);
        mSelectedTextSize = attributesArray.getDimension(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_selectedTextSize, spToPx(mSelectedTextSize));
        mTextColor = attributesArray.getColor(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_textColor, mTextColor);
        mTextSize = attributesArray.getDimension(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_textSize, spToPx(mTextSize));
        mTypeface = Typeface.create(attributesArray.getString(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_typeface), Typeface.NORMAL);
        mFormatter = stringToFormatter(attributesArray.getString(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_formatter));
        mFadingEdgeEnabled = attributesArray.getBoolean(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_fadingEdgeEnabled, mFadingEdgeEnabled);
        mScrollerEnabled = attributesArray.getBoolean(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_scrollerEnabled, mScrollerEnabled);
        mWheelItemCount = attributesArray.getInt(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_wheelItemCount, mWheelItemCount);
        ...
        inflater.inflate(com.shawnlin.numberpicker.R.layout.number_picker_with_selector_wheel, this, true);

        // input text
        mSelectedText = findViewById(com.shawnlin.numberpicker.R.id.np__numberpicker_input);
        ...
        mSelectorWheelPaint.setTypeface(selectedTypeface);
        ...
        mWrapSelectorWheel = attributesArray.getBoolean(com.shawnlin.numberpicker.R.styleable.NumberPicker_np_wrapSelectorWheel, mWrapSelectorWheel);
        ...
        mFlingScroller = new com.shawnlin.numberpicker.Scroller(context, null, true);
        mAdjustScroller = new com.shawnlin.numberpicker.Scroller(context, new DecelerateInterpolator(2.5f));
     ...
     */
    private boolean moveToFinalScrollerPosition(com.shawnlin.numberpicker.Scroller scroller) {
    ...
    public void computeScroll() {
        ...
        com.shawnlin.numberpicker.Scroller scroller = mFlingScroller;
...
//        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            if (i == mWheelMiddleItemIndex) {
                ...
                mSelectorWheelPaint.setTypeface(notselectedTypeface);
            }
     ...
     */
    private void onScrollerFinished(com.shawnlin.numberpicker.Scroller scroller) {
    ...
    public void setTypeface(Typeface typeface) {
        mTypeface = typeface;
        if (mTypeface != null) {
            mSelectedText.setTypeface(selectedTypeface);
            mSelectorWheelPaint.setTypeface(selectedTypeface);
        } else {
